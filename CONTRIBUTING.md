...
We try to keep the metadata of phone_numbers_parser up to date and making sure you are running on the latest release will be sufficient for most apps. However, you can also update the metadata yourself by following just 2 simple steps:

1. Download and Process the Metadata
2. Generate the Dart files

## 1. Download and Process Metadata
