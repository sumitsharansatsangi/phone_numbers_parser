...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.HK: PhoneMetadataPatterns(
    ...
    mobile:
        r"(?:4(?:44[5-9]|6(?:1[0-6]|4[0-57-9]|6[0-4]))|573[0-6]|6(?:26[013-8]|66[0-3])|70(?:7[1-5]|8[0-4])|848[0-25-9]|9(?:29[013-9]|59[0-4]|899))\d{4}|(?:4(?:4[015]|6[023578])|5(?:[1-59][0-46-9]|6[0-4689]|7[0-246-9])|6(?:0[1-9]|[13-59]\d|[268][0-57-9]|7[0-79])|84[09]|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\d))\d{5}",
    fixedLine:
